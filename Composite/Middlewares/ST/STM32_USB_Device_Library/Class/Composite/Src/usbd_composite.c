/**
  ...
  * @version        : v2.0_Cube
  * @brief          : Usb device for USB composite device.
  ******************************************************************************
  * @attention
  *
...
__ALIGN_BEGIN uint8_t USBD_Composite_CfgFSDesc[USBD_COMPOSITE_DESC_SIZE]  __ALIGN_END =
{
  ...
  USBD_COMPOSITE_DESC_SIZE,             /* wTotalLength:no of returned bytes */
  0x00,
  USBD_MAX_NUM_INTERFACES ,  /* bNumInterfaces: USBD_MAX_NUM_INTERFACES interface */
  0x01,   /* bConfigurationValue: */
  0x04,   /* iConfiguration: Index of string descriptor describing the configuration */ //TOCHECK:
  ...
  0x02,   /* bInterfaceSubClass: */ //TOCHECK:
  ...
  0x00,                              /* bInterval: ignore for Bulk transfer */ //TOCHECK
  ...
  LOBYTE(CDC_DATA_FS_MAX_PACKET_SIZE),  /* wMaxPacketSize: */
  HIBYTE(CDC_DATA_FS_MAX_PACKET_SIZE),
  0x01,                               /* bInterval: ignore for Bulk transfer */ //TOCHECK:
